...
curl -kfsSL https://raw.githubusercontent.com/mdkeenan/linux/master/ocrap-commands.sh -o /usr/local/src/ocrap-commands.sh

# Run the commands in ocrap-commands.sh.
